...
#define RightObstacleSensor 3  //Right obstacle sensor to D3 (front direction is from arduino point to voltage meter)
#define LeftObstacleSensor 4   //Left obstacle sensor to D4
