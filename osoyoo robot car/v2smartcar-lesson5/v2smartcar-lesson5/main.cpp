...
// #define SERVO_PIN 10 // servo connect to D10

// #define Echo_PIN 2  // Ultrasonic Echo pin connect to D2
// #define Trig_PIN 3 // Ultrasonic Trig pin connect to D3

// #define BUZZ_PIN 13
// #define FAST_SPEED 350  // both sides of the motor speed
// #define SPEED 220       // both sides of the motor speed
// #define TURN_SPEED 300  // both sides of the motor speed
// #define BACK_SPEED1 355 // back speed
// #define BACK_SPEED2 190  // back speed

// int leftscanval, centerscanval, rightscanval, ldiagonalscanval, rdiagonalscanval;
// const int distancelimit = 3;     // distance limit for obstacles in front
// const int sidedistancelimit = 3; // minimum distance in cm to obstacles at both sides (the car will allow a shorter distance sideways)
// int distance;
// int numcycles = 0;
...
//   set_Motorspeed(SPEED, SPEED); //! Remove when NOT testing
// }
